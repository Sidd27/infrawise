...
} from '@infrawise/adapters-aws-services';
import { extractLogsSummary } from '@infrawise/adapters-logs';
...
import type { ServicesMeta } from '@infrawise/shared';
...
export async function runAnalyze(options: AnalyzeOptions = {}): Promise<void> {
  ...
  const findings = await (async () => {
    ...
    } = await import('@infrawise/analyzers');
