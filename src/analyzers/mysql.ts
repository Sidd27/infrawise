 ...
 */
export async function MissingMySQLIndexAnalyzer(graph: SystemGraph): Promise<Finding[]> {
 ...
 */
export async function MySQLFullTableScanAnalyzer(graph: SystemGraph): Promise<Finding[]> {
  const findings: Finding[] = [];
