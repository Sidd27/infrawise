 ...
 */
export async function MissingMongoIndexAnalyzer(graph: SystemGraph): Promise<Finding[]> {
 ...
 */
export async function MongoCollectionScanAnalyzer(graph: SystemGraph): Promise<Finding[]> {
  const findings: Finding[] = [];
