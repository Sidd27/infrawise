...
Infrawise scans your infrastructure, runs 27 analyzers, and writes `.mcp.json` to the current directory. Open Claude Code in the same directory — all 15 MCP tools are immediately available.
